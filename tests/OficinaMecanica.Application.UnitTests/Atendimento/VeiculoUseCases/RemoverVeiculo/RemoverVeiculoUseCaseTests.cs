...
public class RemoverVeiculoUseCaseTests
{
    ...
    public async Task Dado_VeiculoExistente_Quando_RemoverVeiculo_Entao_DeveRemoverVeiculo()
    {
        ...
        // Act
        var resultado = await useCase.ExecuteAsync(new RemoverVeiculoRequest(veiculo.Id));
    ...
    public async Task Dado_VeiculoInexistente_Quando_RemoverVeiculo_Entao_DeveRetornarFalha()
    {
        ...
        // Act
        var resultado = await useCase.ExecuteAsync(new RemoverVeiculoRequest(Guid.NewGuid()));
        ...
        repository.Verify(
            repo => repo.RemoverAsync(It.IsAny<Veiculo>(), It.IsAny<CancellationToken>()),
            Times.Never);
    }
    ...
    public async Task Dado_IdVazio_Quando_RemoverVeiculo_Entao_DeveRetornarFalhaDeValidacao()
    {
        ...
        // Act
        var resultado = await useCase.ExecuteAsync(new RemoverVeiculoRequest(Guid.Empty));
