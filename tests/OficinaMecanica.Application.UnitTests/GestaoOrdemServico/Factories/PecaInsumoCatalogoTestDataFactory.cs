...
{
    public static PecaInsumoCatalogo CriarPecaInsumoCatalogoPadrao(string descricao = "Filtro de oleo", TipoPecaInsumo tipo = TipoPecaInsumo.PECA, decimal valor = 45m)
    {
