...
public class FinalizarServicoUseCaseTests
{
    ...
    public async Task Dado_OrdemServicoEmExecucaoComServicoEmExecucao_Quando_FinalizarServico_Entao_DeveAtualizarServicoEPersistir()
    {
        ...
        var request = OrdemServicoTestDataFactory.CriarFinalizarServicoRequestValido(ordemServico.Id, servicoId);
    ...
    public async Task Dado_OrdemServicoInexistente_Quando_FinalizarServico_Entao_DeveRetornarFalha()
    {
        ...
        var request = OrdemServicoTestDataFactory.CriarFinalizarServicoRequestValido();
    ...
    [Fact]
    public async Task Dado_OrdemServicoIdVazio_Quando_FinalizarServico_Entao_DeveRetornarFalhaDeValidacao()
    {
        // Arrange
        ...
        var request = OrdemServicoTestDataFactory.CriarFinalizarServicoRequestValido(ordemServicoId: Guid.Empty);
    ...
    [Fact]
    public async Task Dado_ServicoIdVazio_Quando_FinalizarServico_Entao_DeveRetornarFalhaDeValidacao()
    {
        // Arrange
        var repository = new Mock<IOrdemServicoRepository>();
        ...
        var request = OrdemServicoTestDataFactory.CriarFinalizarServicoRequestValido(servicoId: Guid.Empty);
    ...
    {
        return new FinalizarServicoUseCase(repository.Object, new FinalizarServicoValidator(), MapperFactory.Criar());
    }
}
