# ADR-0010 — RDS single-AZ sem backup automatizado para ambiente de laboratório
...
> A ADR-0003 (Fase 1) já definiu SQL Server como o banco relacional do projeto. Esta ADR trata de uma decisão diferente: como esse banco é configurado na instância real do RDS na AWS, para um ambiente que é criado e destruído a cada demonstração, dentro do orçamento limitado do AWS Academy Learner Lab.
