...
| `TF_STATE_BUCKET` | Environment variable obrigatória | Nome de bucket S3 existente, por exemplo `oficina-mecanica-tfstate-<account-id>`. | Bucket do Terraform state. A esteira não cria bucket automaticamente. |
