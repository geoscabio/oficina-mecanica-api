...
{
    private static readonly ClienteSeed ClienteMaria = new(
        "52998224725",
        "Maria Oliveira",
        "Rua das Oficinas",
        "100",
    ...
    private static readonly ClienteSeed ClienteCarlos = new(
        "04252011000110",
        "Carlos Souza",
        "Avenida Brasil",
        "250",
    ...
    public static Task<Cliente> ObterOuCriarMariaAsync(
    ...
    public static Task<Cliente> ObterOuCriarCarlosAsync(
        OficinaMecanicaDbContext dbContext,
        CancellationToken cancellationToken)
    {
    ...
    private static async Task<Cliente> ObterOuCriarAsync(
        OficinaMecanicaDbContext dbContext,
        ClienteSeed seed,
        CancellationToken cancellationToken)
    {
        ...
        var cliente = Cliente.Criar(
            CpfCnpj.Criar(seed.Documento),
            seed.Nome,
            new Endereco(seed.Logradouro, seed.Numero, seed.Bairro, seed.Cidade, seed.Cep),
            Telefone.Criar(seed.Telefone),
            Email.Criar(seed.Email));
    ...
    private sealed record ClienteSeed(
        string Documento,
        string Nome,
        string Logradouro,
        string Numero,
