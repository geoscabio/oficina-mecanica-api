...
internal static class PecaInsumoCatalogoSeedData
{
    ...
    public static Task<PecaInsumoCatalogo> ObterOuCriarFiltroOleoAsync(OficinaMecanicaDbContext dbContext, CancellationToken cancellationToken)
    {
        return ObterOuCriarAsync(dbContext, PecaFiltroOleo, cancellationToken);
    }

    public static Task<PecaInsumoCatalogo> ObterOuCriarPastilhaFreioAsync(OficinaMecanicaDbContext dbContext, CancellationToken cancellationToken)
    {
        return ObterOuCriarAsync(dbContext, PecaPastilhaFreio, cancellationToken);
    }

    public static Task<PecaInsumoCatalogo> ObterOuCriarOleoMotorAsync(OficinaMecanicaDbContext dbContext, CancellationToken cancellationToken)
    {
        return ObterOuCriarAsync(dbContext, InsumoOleoMotor, cancellationToken);
    }

    private static async Task<PecaInsumoCatalogo> ObterOuCriarAsync(OficinaMecanicaDbContext dbContext, PecaInsumoSeed seed, CancellationToken cancellationToken)
    {
