...
public sealed class DetalharOrdemServicoUseCase
{
    private readonly IOrdemServicoRepository _ordemServicoRepository;
    private readonly IValidator<DetalharOrdemServicoRequest> _validator;
    private readonly IMapper _mapper;

    public DetalharOrdemServicoUseCase(IOrdemServicoRepository ordemServicoRepository, IValidator<DetalharOrdemServicoRequest> validator, IMapper mapper)
    {
    ...
    public async Task<Result<OrdemServicoResponse>> ExecuteAsync(DetalharOrdemServicoRequest request, CancellationToken cancellationToken = default)
    {
