...
public sealed class ConsultarServicoCatalogoUseCase
{
    ...
    public ConsultarServicoCatalogoUseCase(IServicoCatalogoRepository servicoCatalogoRepository, IValidator<ConsultarServicoCatalogoRequest> validator, IMapper mapper)
    {
    ...
    public async Task<Result<ServicoCatalogoResponse>> ExecuteAsync(ConsultarServicoCatalogoRequest request, CancellationToken cancellationToken = default)
    {
