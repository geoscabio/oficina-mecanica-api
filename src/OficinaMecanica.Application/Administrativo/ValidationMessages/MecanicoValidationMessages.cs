...
public static class MecanicoValidationMessages
{
    ...
    public const string RequestAtualizarMecanicoObrigatorio = "Request para atualizar mecânico é obrigatório.";
    public const string RequestRemoverMecanicoObrigatorio = "Request para remover mecânico é obrigatório.";
    public const string RequestConsultarMecanicoObrigatorio = "Request para consultar mecânico é obrigatório.";
    ...
    public const string IdMecanicoObrigatorio = "Id do mecânico é obrigatório.";
}