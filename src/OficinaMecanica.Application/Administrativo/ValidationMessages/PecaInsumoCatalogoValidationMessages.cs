...
public static class PecaInsumoCatalogoValidationMessages
{
    ...
    public const string RequestRemoverPecaInsumoCatalogoObrigatorio = "Request para remover peça ou insumo do catálogo é obrigatório.";
    public const string RequestConsultarPecaInsumoCatalogoObrigatorio = "Request para consultar peça ou insumo do catálogo é obrigatório.";
