...
public sealed class ListarMecanicosUseCase
{
    ...
    public ListarMecanicosUseCase(
        IMecanicoRepository mecanicoRepository,
        IValidator<ListarMecanicosRequest> validator,
        IMapper mapper)
    {
    ...
    public async Task<Result<PagedResult<MecanicoResponse>>> ExecuteAsync(
        ListarMecanicosRequest request,
        CancellationToken cancellationToken = default)
    {
        ...
        var mecanicos = await _mecanicoRepository.ListarAsync(
            request.Pagina,
        ...
        var pagedResult = new PagedResult<MecanicoResponse>(
            response,
            request.Pagina,
            request.TamanhoPagina,
            totalItens);
