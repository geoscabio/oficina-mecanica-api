...
public sealed class AtualizarMecanicoUseCase
{
    ...
    public AtualizarMecanicoUseCase(IMecanicoRepository mecanicoRepository, IValidator<AtualizarMecanicoRequest> validator, IMapper mapper)
    {
    ...
    public async Task<Result<MecanicoResponse>> ExecuteAsync(AtualizarMecanicoRequest request, CancellationToken cancellationToken = default)
    {
