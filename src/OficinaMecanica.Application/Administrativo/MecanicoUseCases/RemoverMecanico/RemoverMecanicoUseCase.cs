...
public sealed class RemoverMecanicoUseCase
{
    ...
    public RemoverMecanicoUseCase(IMecanicoRepository mecanicoRepository, IValidator<RemoverMecanicoRequest> validator, IMapper mapper)
    {
    ...
    public async Task<Result<MecanicoResponse>> ExecuteAsync(RemoverMecanicoRequest request, CancellationToken cancellationToken = default)
    {
