...
public sealed class ListarClientesUseCase
{
    ...
    public ListarClientesUseCase(
        ...
        IValidator<ListarClientesRequest> validator,
        IMapper mapper)
    {
    ...
    public async Task<Result<PagedResult<ClienteResponse>>> ExecuteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return Result<PagedResult<ClienteResponse>>.Falha(
        ...
        var pagedResult = new PagedResult<ClienteResponse>(
            response,
            request.Pagina,
            request.TamanhoPagina,
            totalItens);
