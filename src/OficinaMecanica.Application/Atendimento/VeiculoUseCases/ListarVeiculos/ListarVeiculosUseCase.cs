...
public sealed class ListarVeiculosUseCase
{
    ...
    public ListarVeiculosUseCase(
        IVeiculoRepository veiculoRepository,
        IValidator<ListarVeiculosRequest> validator,
        IMapper mapper)
    {
    ...
    public async Task<Result<PagedResult<VeiculoResponse>>> ExecuteAsync(
        ListarVeiculosRequest request,
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return Result<PagedResult<VeiculoResponse>>.Falha(
        ...
        var pagedResult = new PagedResult<VeiculoResponse>(
            response,
            request.Pagina,
            request.TamanhoPagina,
            totalItens);
