...
public sealed class AtualizarVeiculoUseCase
{
    ...
    public AtualizarVeiculoUseCase(IVeiculoRepository veiculoRepository, IValidator<AtualizarVeiculoRequest> validator, IMapper mapper)
    {
    ...
    public async Task<Result<VeiculoResponse>> ExecuteAsync(AtualizarVeiculoRequest request, CancellationToken cancellationToken = default)
    {
        ...
        veiculo.Atualizar(Placa.Criar(request.Placa), request.Marca, request.Modelo, request.Ano);
